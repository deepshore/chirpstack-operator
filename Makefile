...
# deepshore.de/chirpstack-operator-bundle:$VERSION and deepshore.de/chirpstack-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/maltegroth/chirpstack-operator
